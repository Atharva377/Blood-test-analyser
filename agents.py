...
from tools import search_tool, blood_test_report_tool  # Fixed: import the actual function, not BloodTestReportTool
...
doctor=Agent(
    ...
    tools=[blood_test_report_tool],  # Fixed: use the function directly, not a class method
    llm=llm,
    max_iter=1,
    max_rpm=1,
